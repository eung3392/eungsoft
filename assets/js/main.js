...
const translations = {
  ko: {
    ...
    "hero.subtitle": "사용자의 니즈를 생각하는 실용적인 소프트웨어를 만듭니다.",
  ...
  en: {
    ...
    "hero.title": "EUNG SOFT",
    "hero.subtitle": "Building practical software focused on user needs.",
    "hero.desc": "Providing optimized apps for Rokid Glasses, Android utilities, and professional IT books.",
